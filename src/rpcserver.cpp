...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BAKER features */
        {"baker", "masternode", &masternode, true, true, false},
        {"baker", "masternodelist", &masternodelist, true, true, false},
        {"baker", "mnbudget", &mnbudget, true, true, false},
        {"baker", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"baker", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"baker", "mnsync", &mnsync, true, true, false},
        {"baker", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bakerd, or the -server option to baker-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> baker-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16432/\n";
}
