...
/** Utility functions used by the BAKER Qt UI.
 */
namespace GUIUtil
{
...
// Render BAKER addresses in monospace font
...
// Parse "baker:" URI into recipient object, return true on successful parsing
