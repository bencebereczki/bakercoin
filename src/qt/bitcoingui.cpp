                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BAKER-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BAKER address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and baker: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BAKER Core"), this);
    aboutAction->setStatusTip(tr("Show information about BAKER Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BAKER"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BAKER addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BAKER addresses"));
    ...
    openAction->setStatusTip(tr("Open a BAKER: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BAKER Core help message to get a list with possible BAKER command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BAKER Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BAKER network", "", count));
}
...
{
    QString strTitle = tr("BAKER Core"); // default title
