...
#if defined(NDEBUG)
#error "BAKER cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BAKER Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 1 && nHeight > 0) {
		...
		nSubsidy = 1 * COIN;
	} else if (nHeight > 3000 && nHeight <= 16000) {
		nSubsidy = 10 * COIN;
	} else if (nHeight > 16000 && nHeight <= 26000) {
		nSubsidy = 12 * COIN;
	} else if (nHeight > 26000 && nHeight <= 36000) {
		nSubsidy = 14 * COIN;
	} else if (nHeight > 36000 && nHeight <= 66000) {
		nSubsidy = 16 * COIN;
	} else {
		nSubsidy = 10 * COIN;
	}
