...
In order to support loading of multiple wallets in baker-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is baker.cpp.
...
Changes to baker.cpp
----------------------
baker.cpp is the entry point into baker-qt, and as such, will require some minor modifications to provide hooks for
