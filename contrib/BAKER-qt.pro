...
RESOURCES += src/qt/baker.qrc src/qt/baker_locale.qrc

TRANSLATIONS += src/qt/locale/baker_bg.ts \
                src/qt/locale/baker_de.ts \
                src/qt/locale/baker_en.ts \
                src/qt/locale/baker_es.ts \
                src/qt/locale/baker_fi.ts \
                src/qt/locale/baker_fr.ts \
                src/qt/locale/baker_it.ts \
                src/qt/locale/baker_ja.ts \
                src/qt/locale/baker_pl.ts \
                src/qt/locale/baker_pt.ts \
                src/qt/locale/baker_ru.ts \
                src/qt/locale/baker_sk.ts \
                src/qt/locale/baker_sv.ts \
                src/qt/locale/baker_vi.ts \
                src/qt/locale/baker_zh_CN.ts \
                src/qt/locale/baker_zh_TW.ts
